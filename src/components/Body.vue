<template>
  <div class="container my-4">
    <div
      class="mt-4 mb-2 text-left md:text-left text-base md:text-base lg:text-lg open-sans-regular leading-normal"
    >
      {{ province }}
      <br>
    </div>
    ...
    >
      <title>Кликните на части тела чтобы узнать симптомы</title>
      <path
        class="hand-right"
        id="hand-right"
        title="Боли в мышцах"
      ...
      <path
        ...
        id="hand-left"
        title="Боли в мышцах"
        d="M175.56,348.54c0,5.26-2.87,6.53-5.42,11.47s0.64,15.94.64,15.94c-2.23,14.82-.48,14.82,2.23,14.66s6.53-12.75,6.53-12.75l4-1.91s3.19,3.51.8,8.92-16.25,12.75-14.66,14.66,6.37-.16,6.37-0.16-9.56,9.24-8.45,10.36a3.53,3.53,0,0,0,2.87.8s-2.71,3.19-.48,4.62,8.61-3.19,8.61-3.19c8.76-1.28,17.21-22.63,18.49-25s-2.07-30.28-3-40.64Z"
        transform="translate(0.5 0.5)"
      />
      <path
        class="forearm-left"
      ...
      <path
        class="head-center"
        id="head-center"
        title="Головная боль, потеря чувства вкуса и/или обоняния, заложенность носа"
      ...
      <path
        class="torso-lower"
        id="torso-lower"
        title="Затрудненное дыхание и дыхательная недостаточность, может отмечаться диарея"
      ...
      <path
        class="torso-upper"
        id="torso-upper"
        title="Сухой кашель, затрудненное дыхание и дыхательная недостаточность"
...
export default {
  ...
  data() {
    return {
      province:
        "Общими симптомами являются высокая температура и ощущение усталости",
      id: "ID of the province",
      msg: "Кликните на части тела чтобы узнать симптомы"
    };
  },
  mounted() {
